...
//
//    // subscribe from here
//    Flux<Object> sec02flux = sinkMulticast.asFlux();
//
//    sinkMulticast.tryEmitNext("test 1 sink multicast");
//    sinkMulticast.tryEmitNext("test 2 sink multicast");
//
//    sec02flux.subscribe(Util.getSubscriber("sub 1")); // will receive all 3 messages - as there were no subscribers before
//    sec02flux.subscribe(Util.getSubscriber("sub 2")); // will receive last msg only as only 1 item was emitted after subscription
//
